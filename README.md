...
Неоходимо наличие следующих шрифтов:
...
При нажатии на кнопку «Платежи» в главном окне пользователь выбирает, что он хочет «оплатить» - мобильную связь или интернет. Также пользователь может вернуться обратно в главное меню, нажав на кнопку «Назад». При нажатии на одну из кнопок для совершения платежей открывается идентичный интерфейс для оплаты, в котором пользователю необходимо ввести сумму платежа. При выборе вкладки «Мобильная связь» пользователь также должен выбрать оператора, которому принадлежит номер, который он хочет пополнить. 
